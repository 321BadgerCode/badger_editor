...
public static class audio_1
{
	...
	public static void play(double? A1, double? A2, double? A3, double? A4)
	{
		FileStream stream = new FileStream(".\\test.wav", FileMode.Create);
...
//change function to play sound, but to not make it into file